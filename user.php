                                ...
                                if(mysqli_num_rows($query) > 0){
                                    ...
                                    if($_SESSION['username'] == $row['username']){
                                        ...
                                        if($row['id_user'] == 1){
                                          ...
                                          echo ' <a class="btn small #00897b waves-effect waves-light" href="?page=sett&sub=usr&act=edit&id_user='.$row['id_user'].'">
                                                 <i class="material-icons">edit</i> EDIT</a>
                                                 <a class="btn small #00897b waves-effect waves-light" href="?page=sett&sub=usr&act=del&id_user='.$row['id_user'].'"><i class="material-icons">delete</i> DEL</a>';
                                        }
                                    } echo '</td>
                                    </tr>
                                </tbody>';
