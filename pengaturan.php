        ...
        if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 2){
            ...
            if(isset($_REQUEST['sub'])){
                ...
                if(isset($_REQUEST['submit'])){
                    ...
                    if ($_REQUEST['institusi'] == "" || $_REQUEST['nama'] == "" || $_REQUEST['alamat'] == "" || $_REQUEST['direktorat'] == "" || $_REQUEST['website'] == "" || $_REQUEST['email'] == ""){
                        ...
                        $direktorat = $_REQUEST['direktorat'];
                        ...
                        if(!preg_match("/^[a-zA-Z0-9. -]*$/", $nama)){
                            $_SESSION['namains'] = 'Form Nama hanya boleh mengandung karakter huruf, angka, spasi, titik(.) dan minus(-)';
                            echo '<script language="javascript">window.history.back();</script>';
                        } else {

                            if(!preg_match("/^[a-zA-Z0-9. -]*$/", $institusi)){
                                $_SESSION['institusi'] = 'Form Nama Perusahaan hanya boleh mengandung karakter huruf, angka, spasi, titik(.) dan minus(-)';
                                echo '<script language="javascript">window.history.back();</script>';
                            } else {
                                                        ...
                                                        if(!empty($logo)){
                                                            ...
                                                            if(in_array($eks, $ekstensi) == true){
                                                                if($ukuran < 2000000){
                                                                    ...
                                                                    $query = mysqli_query($config, "UPDATE tbl_instansi SET institusi='$institusi',nama='$nama',alamat='$alamat',direktorat='$direktorat',website='$website',email='$email',logo='$nlogo',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                                                            ...
                                                            $query = mysqli_query($config, "UPDATE tbl_instansi SET institusi='$institusi',nama='$nama',alamat='$alamat',direktorat='$direktorat',website='$website',email='$email',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                            ...
                            <form class="col s12" method="post" action="?page=sett" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="direktorat" type="text" class="validate" name="direktorat" value="<?php echo $row['direktorat']; ?>" required>
                                            <?php
                                                if(isset($_SESSION['direktorat'])){
                                                    $direktorat = $_SESSION['direktorat'];
                                                    echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$direktorat.'</div>';
                                                    unset($_SESSION['direktorat']);
                                                }
                                            ?>
                                        <label for="direktorat">Divisi</label>
                                    </div>
                                    <div class="input-field col s6">
