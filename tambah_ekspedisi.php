...

 {
                                                    ...
                                                    if($file != ""){
                                                        ...
                                                        if(in_array($eks, $ekstensi) == true){
                                                            if($ukuran < 2500000){
                                                                ...
                                                                $query = mysqli_query($config, "INSERT INTO ekspedisi(nama,tujuan,sifat_dokumen,no_resi,divisi,pemeriksa,tgl_surat,
                                                                    tgl_diterima,file,no_surat,id_user,ttd_avp,ttd_pemeriksa)
                                                                        VALUES('$nama','$tujuan','$sifat_dokumen','$no_resi','$divisi','$pemeriksa','$tgl_surat',NOW(),'$nfile','$no_surat','$id_user','Belum Disetujui','Belum Disetujui')");
                                                        ...
                                                        $query = mysqli_query($config, "INSERT INTO ekspedisi(nama,tujuan,sifat_dokumen,no_resi,divisi,pemeriksa,tgl_surat, tgl_diterima,file,no_surat,id_user,ttd_avp,ttd_pemeriksa)
                                                            VALUES('$nama','$tujuan','$sifat_dokumen','$no_resi','$divisi','$pemeriksa','$tgl_surat',NOW(),'','$no_surat','$id_user','Belum Disetujui','Belum Disetujui')");
         ...
         {?>
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper teal darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=ekspedisi&act=add" class="judul"><i class="material-icons">local_shipping</i> Tambah Permintaan Ekspedisi</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <!-- Form START -->
                <form class="col s12" method="POST" action="?page=ekspedisi&act=add" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Isi No.Surat">
                            ...
                            <input id="no_surat" type="number" class="validate" name="no_surat">
                        ...
                        <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Isi No.Resi">
                            ...
                            <input id="no_resi" type="number" class="validate" name="no_resi">
                            <label for="no_resi">No. Resi</label>
                        </div>
                            <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Isi Tanggal Pengiriman">
                        ...
                        <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Pilih Sifat Dokumen">
                            ...
                            <select class="browser-default validate" id="sifat_dokumen" name="sifat_dokumen" required>
                                    <option hidden>Pilih Sifat Dokumen</option>
                        ...
                        <div class="input-field col s6">
                            <div class="file-field input-field tooltipped" data-position="top" data-tooltip="Jika tidak ada file/scan gambar ekspedisi, biarkan kosong">
                                ...
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" placeholder="Upload file/scan gambar ekspedisi">
                                        <?php
