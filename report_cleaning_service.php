    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == ""){
                header("Location: ./admin.php?page=acs");
                die();
            } else {

                $query = mysqli_query($config, "SELECT * FROM cleaning_service WHERE tgl_diterima BETWEEN '$dari_tanggal' AND '$sampai_tanggal'");
                ...
                echo '
                            ...
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper teal darken-1">
                                        <div class="col 12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light"><a href="?page=acs" class="judul"><i class="material-icons">print</i> Cetak Report Invoice Cleaning Service<a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
                    ...
                    <div class="row agenda">
                        <div class="col s10">
                            ...
                            <h5 class="hid">REPORT INVOICE CLEANING SERVICE</h5>';
                            ...
                            <p class="warna agenda">Report Invoice Cleaning Service dari tanggal <strong>'.$d." ".$nm." ".$y.'</strong> sampai dengan tanggal <strong>'.$d2." ".$nm2." ".$y2.'</strong></p>
                        </div>
                        <div class="col s2">
                    ...
                    <div id="colres" class="warna cetak">
                        <table class="bordered" id="tbl" width="100%">
                            ...
                            if(mysqli_num_rows($query) > 0){
                                ...
                                echo '<tr><td colspan="9"><center><p class="add">Tidak ada report Invoice Cleaning Service</p></center></td></tr>';
                            } echo '
                        </table>
                    </div>';
            }
                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper teal darken-1">
                                    <div class="col 12">
                                        <ul class="left">
                                            <li class="waves-effect waves-light"><a href="?page=ask" class="judul"><i class="material-icons">print</i> Cetak Report Cleaning Service<a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
