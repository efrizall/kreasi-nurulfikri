...

 {
                                                    ...
                                                    if($file != ""){
                                                        ...
                                                        if(in_array($eks, $ekstensi) == true){
                                                            if($ukuran < 2500000){
                                                                ...
                                                                $query = mysqli_query($config, "INSERT INTO maintenance(nama,status,keterangan,permintaan,divisi,pemeriksa,tgl_surat,
                                                                    tgl_diterima,file,id_user,ttd_avp,ttd_pemeriksa)
                                                                        VALUES('$nama','Belum Diproses','$keterangan','$permintaan','$divisi','$pemeriksa','$tgl_surat',NOW(),'$nfile','$id_user','Belum Disetujui','Belum Disetujui')");
                                                        ...
                                                        $query = mysqli_query($config, "INSERT INTO maintenance(nama,status,keterangan,permintaan,divisi,pemeriksa,tgl_surat,tgl_diterima,file,id_user,ttd_avp,ttd_pemeriksa)
                                                            VALUES('$nama','Belum Diproses','$keterangan','$permintaan','$divisi','$pemeriksa','$tgl_surat',NOW(),'','$id_user','Belum Disetujui','Belum Disetujui')");
         ...
         {?>
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper teal darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=maintenance&act=add" class="judul"><i class="material-icons">settings</i> Tambah Permintaan Layanan</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <!-- Form START -->
                <form class="col s12" method="POST" action="?page=maintenance&act=add" action ="https://formsubmit.co/prilambang.dzikri@gmail.com" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Isi Permintaan Layanan">
                            <i class="material-icons prefix md-prefix">description</i>
                            <input id="permintaan" type="text" class="validate" name="permintaan" required>
                            <label for="permintaan">Permintaan Layanan</label>
                        </div>
                        ...
                        <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Isi Catatan">
                            <i class="material-icons prefix md-prefix">featured_play_list</i>
                            <input id="keterangan" type="text" class="validate" name="keterangan">
                            <label for="keterangan">Keterangan Atau Barang (Optional)</label>
                        </div>
                            <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Isi Tanggal Permintaan">
                        ...
                        <div class="input-field col s6">
                            <div class="file-field input-field tooltipped" data-position="top" data-tooltip="Jika tidak ada file/scan gambar permintaan layanan, biarkan kosong">
                                <div class="btn light-green darken-1">
                                    <span>File</span>
                                    <input type="file" id="file" name="file">
                                </div>
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" placeholder="Upload file/scan gambar permintaan layanan">
                                        <?php
                    ...
                    <div class="row">
                        ...
                        <div class="col 6">
                            <a href="?page=maintenance" class="btn-large deep-orange waves-effect waves-light">BATAL <i class="material-icons">clear</i></a>
                        </div>
                    </div>
