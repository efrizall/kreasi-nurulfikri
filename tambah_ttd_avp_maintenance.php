        ...
        if(isset($_REQUEST['submit'])){
            ...
            list($id_surat) = mysqli_fetch_array($query);
                ...
                $id_user = $_SESSION['id_user'];
                                    ...
                                    $query = mysqli_query($config, "INSERT INTO ttd_vp(nama_ttd,divisi_ttd,status_ttd,tgl_surat_ttd,id_surat,id_user)
                                        VALUES('$nama_ttd','$divisi_ttd','barcode_avp_maintenance',NOW(),'$id_surat','$id_user')");
