<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        $query = mysqli_query($config, "SELECT * FROM transportasi JOIN pemeriksa_transportasi ON transportasi.id_surat = pemeriksa_transportasi.id_surat WHERE transportasi.id_surat='$id_surat'");
