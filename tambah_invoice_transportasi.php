...

 {
                                                    ...
                                                    if($file != ""){
                                                        ...
                                                        if(in_array($eks, $ekstensi) == true){
                                                            if($ukuran < 2500000){
                                                                ...
                                                                $query = mysqli_query($config, "INSERT INTO invoice_transportasi(nama_pembuat,kode_bon,nominal,vendor,lampiran,tgl_surat,
                                                                    tgl_diterima,file,id_user)
                                                                        VALUES('$nama_pembuat','$kode_bon','$nominal','$vendor','$lampiran','$tgl_surat',NOW(),'$nfile','$id_user')");
                                                        ...
                                                        $query = mysqli_query($config, "INSERT INTO invoice_transportasi(nama_pembuat,kode_bon,nominal,vendor,lampiran,tgl_surat, tgl_diterima,file,id_user)
                                                            VALUES('$nama_pembuat','$kode_bon','$nominal','$vendor','$lampiran','$tgl_surat',NOW(),'','$id_user')");
         ...
         {?>
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper teal darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=invoice_transportasi&act=add" class="judul"><i class="material-icons">description</i> Tambah Invoice Transportasi</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <!-- Form START -->
                <form class="col s12" method="POST" action="?page=invoice_transportasi&act=add" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Masukkan angka 0-9 tanpa titik dan koma">
                            <div class="file-field input-field tooltipped" data-position="top" data-tooltip="Jika tidak ada file/scan gambar invoice transportasi, biarkan kosong">
                                ...
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" placeholder="Upload file/scan gambar invoice transportasi">
                                        <?php
