<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        $query = mysqli_query($config, "SELECT * FROM ekspedisi JOIN pemeriksa_ekspedisi ON ekspedisi.id_surat = pemeriksa_ekspedisi.id_surat WHERE ekspedisi.id_surat='$id_surat'");
