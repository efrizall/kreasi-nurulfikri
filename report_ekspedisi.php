    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == ""){
                header("Location: ./admin.php?page=ae");
                die();
            } else {

                $query = mysqli_query($config, "SELECT * FROM ekspedisi WHERE tgl_diterima BETWEEN '$dari_tanggal' AND '$sampai_tanggal'");
                ...
                echo '
                            ...
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper teal darken-1">
                                        <div class="col 12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light"><a href="?page=ae" class="judul"><i class="material-icons">print</i> Cetak Report Ekspedisi<a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
                    ...
                    <div class="row agenda">
                        <div class="col s10">
                            ...
                            <h5 class="hid">REPORT EKSPEDISI</h5>';
                            ...
                            <p class="warna agenda">Report Ekspedisi dari tanggal <strong>'.$d." ".$nm." ".$y.'</strong> sampai dengan tanggal <strong>'.$d2." ".$nm2." ".$y2.'</strong></p>
                        </div>
                        <div class="col s2">
                        ...
                        <table class="bordered" id="tbl" width="100%">
                            <thead class="teal lighten-4">
                                <tr>
                                    ...
                                    <th width="15%">Tujuan Pengiriman</th>
                                    <th width="21%">No. Surat</th>
                                    <th width="21%">No. Resi</th>
                                    <th width="18%">Sifat Dokumen</th>
                                    <th width="8%">Tanggal <br/> Pengiriman</th>
                            ...
                            if(mysqli_num_rows($query) > 0){
                                ...
                                while($row = mysqli_fetch_array($query)){
                                 echo '
                                        <td>'.$row['id_surat'].'/FE/RNI/'.$m."/".$y.'</td>
                                        <td>'.$row['nama'].'</td>
                                        <td>'.$row['divisi'].'</td>
                                        <td>'.$row['tujuan'].'</td>
                                        <td>'.$row['no_surat'].'</td>
                                        <td>'.$row['no_resi'].'</td>
                                        <td>'.$row['sifat_dokumen'].'</td>';
                                ...
                                echo '<tr><td colspan="9"><center><p class="add">Tidak ada report Ekspedisi</p></center></td></tr>';
                            } echo '
                        </table>
                    </div>';
            }
                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper teal darken-1">
                                    <div class="col 12">
                                        <ul class="left">
                                            <li class="waves-effect waves-light"><a href="?page=ask" class="judul"><i class="material-icons">print</i> Cetak Report Ekspedisi<a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
