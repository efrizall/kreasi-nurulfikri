    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            list($id_surat) = mysqli_fetch_array($query);
                ...
                $divisi_ttd = $_REQUEST['divisi_ttd'];
                $status_ttd = $_REQUEST['status_ttd'];
                $tgl_surat_ttd = $_REQUEST['tgl_surat_ttd'];
                $id_user = $_SESSION['id_user'];

                                    $query = mysqli_query($config, "INSERT INTO pemeriksa_ekspedisi(nama_ttd,divisi_ttd,status_ttd,tgl_surat_ttd,id_surat,id_user)
                                        VALUES('$nama_ttd','$divisi_ttd','barcode_pemeriksa_ekspedisi',NOW(),'$id_surat','$id_user')");
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper teal darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons">check</i> Setujui</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
