                    ...
                    <div class="card">
				        ...
				        <table>
				            ...
				            <tbody>
                                ...
                                <td width="1%">:</td>
                                <td width="86%">'.$row['id_surat'].'/FE/RNI/'.$tgl = date('m/Y ', strtotime($row['tgl_surat'])).'</td>
                                </tr>
				                <tr>
				                    <td width="13%">Nama</td>
				                    <td width="1%">:</td>
    			                ...
    			                <tr>
    			                    ...
    			                    <td width="86%">';
                                    if(!empty($row['file'])){
                                        echo ' <a class="blue-text" href="?page=ge&act=fe&id_surat='.$row['id_surat'].'">'.$row['file'].'</a>';
                                    } else {
                        ...
                        <div class="card-action">
        	                <a href="?page=ekspedisi&act=del&submit=yes&id_surat='.$row['id_surat'].'" class="btn-large deep-orange waves-effect waves-light white-text">HAPUS <i class="material-icons">delete</i></a>
        	                <a href="?page=ekspedisi" class="btn-large blue waves-effect waves-light white-text">BATAL <i class="material-icons">clear</i></a>
    	                </div>
    	            </div>
                </div>
            </div>
            <!-- Row form END -->';
            	...
            	if(isset($_REQUEST['submit'])){
                    ...
                    if(!empty($row['file'])){
                        ...
                        $query = mysqli_query($config, "DELETE FROM ekspedisi WHERE id_surat='$id_surat'");
                		...
                		if($query == true){
                            ...
                            echo '<script language="javascript">
                                    window.location.href="./admin.php?page=ekspedisi&act=del&id_surat='.$id_surat.'";
                                  </script>';
                		}
                	} else {
