    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == ""){
                header("Location: ./admin.php?page=at");
                die();
            } else {

                $query = mysqli_query($config, "SELECT * FROM transportasi WHERE tgl_diterima BETWEEN '$dari_tanggal' AND '$sampai_tanggal'");
                ...
                echo '
                            ...
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper teal darken-1">
                                        <div class="col 12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light"><a href="?page=at" class="judul"><i class="material-icons">print</i> Cetak Report Transportasi<a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
                    ...
                    <div class="row agenda">
                        <div class="col s10">
                            ...
                            <h5 class="hid">REPORT TRANSPORTASI</h5>';
                            ...
                            <p class="warna agenda">Report Transportasi dari tanggal <strong>'.$d." ".$nm." ".$y.'</strong> sampai dengan tanggal <strong>'.$d2." ".$nm2." ".$y2.'</strong></p>
                        </div>
                        <div class="col s2">
                        ...
                        <table class="bordered" id="tbl" width="100%">
                            <thead class="teal lighten-4">
                                <tr>
                                    ...
                                    <th width="25%">Jenis Mobil</th>
                                    <th width="15%">Tujuan</th>
                                    <th width="15%">Keperluan</th>
                                    <th width="15%">Tanggal <br/> Penggunaan</th>
                                    <th width="15%">Jam Pakai</th>
                            ...
                            if(mysqli_num_rows($query) > 0){
                                ...
                                while($row = mysqli_fetch_array($query)){
                                 echo '
                                        <td>'.$row['id_surat'].'/FPK/RNI/'.$m."/".$y.'</td>
                                        <td>'.$row['nama'].'</td>
                                        <td>'.$row['divisi'].'</td>
                                        ...
                                        $y3 = substr($tanggal_kembali,0,4);
                                        $m3 = substr($tanggal_kembali,5,2);
                                        $d3 = substr($tanggal_kembali,8,2);
                                ...
                                echo '<tr><td colspan="9"><center><p class="add">Tidak ada report Transportasi</p></center></td></tr>';
                            } echo '
                        </table>
                    </div>';
            }
                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper teal darken-1">
                                    <div class="col 12">
                                        <ul class="left">
                                            <li class="waves-effect waves-light"><a href="?page=ask" class="judul"><i class="material-icons">print</i> Cetak Report Transportasi<a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
