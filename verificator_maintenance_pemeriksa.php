<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        $query = mysqli_query($config, "SELECT * FROM maintenance JOIN pemeriksa_maintenance ON maintenance.id_surat = pemeriksa_maintenance.id_surat WHERE maintenance.id_surat='$id_surat'");
