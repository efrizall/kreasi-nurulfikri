...

 {
                                                    ...
                                                    if($file != ""){
                                                        ...
                                                        if(in_array($eks, $ekstensi) == true){
                                                            if($ukuran < 2500000){
                                                                ...
                                                                $query = mysqli_query($config, "INSERT INTO invoice_maintenance(nama_pembuat,kode_bon,nominal,vendor,lampiran,tgl_surat,
                                                        ...
                                                        $query = mysqli_query($config, "INSERT INTO invoice_maintenance(nama_pembuat,kode_bon,nominal,vendor,lampiran,tgl_surat, tgl_diterima,file,id_user)
         ...
         {?>
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper teal darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=invoice_maintenance&act=add" class="judul"><i class="material-icons">description</i> Tambah Invoice Maintenance</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <!-- Form START -->
                <form class="col s12" method="POST" action="?page=invoice_maintenance&act=add" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Isi Kode Bon Keuangan">
                            ...
                            <input id="kode_bon" type="text" class="validate" name="kode_bon" required>
                        ...
                        <div class="input-field col s6">
                            <div class="file-field input-field tooltipped" data-position="top" data-tooltip="Jika tidak ada file/scan gambar surat, biarkan kosong">
                                ...
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" placeholder="Upload file/scan gambar invoice maintenance">
                                        <?php
