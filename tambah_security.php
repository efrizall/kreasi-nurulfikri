...

 {
                                                    ...
                                                    if($file != ""){
                                                        ...
                                                        if(in_array($eks, $ekstensi) == true){
                                                            if($ukuran < 2500000){
                                                                ...
                                                                $query = mysqli_query($config, "INSERT INTO security(nama_pembuat,kode_bon,nominal,vendor,tgl_surat,
                                                        ...
                                                        $query = mysqli_query($config, "INSERT INTO security(nama_pembuat,kode_bon,nominal,vendor,tgl_surat, tgl_diterima,file,id_user)
         ...
         {?>
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper teal darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=security&act=add" class="judul"><i class="material-icons">description</i> Tambah Invoice Security</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <!-- Form START -->
                <form class="col s12" method="POST" action="?page=security&act=add" enctype="multipart/form-data">
                        ...
                        <div class="input-field col s6">
                            <div class="file-field input-field tooltipped" data-position="top" data-tooltip="Jika tidak ada file/scan gambar invoice security, biarkan kosong">
                                ...
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" placeholder="Upload file/scan gambar invoice security">
                                        <?php
