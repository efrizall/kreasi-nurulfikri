...

{
                                            ...
                                            if($file != ""){
                                                ...
                                                if(in_array($eks, $ekstensi) == true){
                                                    if($ukuran < 2300000){
                                                        ...
                                                        $query = mysqli_query($config, "SELECT file FROM transportasi WHERE id_surat='$id_surat'");
                                                        ...
                                                        if(!empty($file)){
                                                            ...
                                                            $query = mysqli_query($config, "UPDATE transportasi SET nama='$nama',tujuan='$tujuan',keperluan='$keperluan',divisi='$divisi',pemeriksa='$pemeriksa',tgl_kembali='$tgl_kembali',tgl_surat='$tgl_surat',file='$nfile',jam_pakai='$jam_pakai',id_user='$id_user' WHERE id_surat='$id_surat'");
                                                ...
                                                $query = mysqli_query($config, "UPDATE transportasi SET nama='$nama',tujuan='$tujuan',keperluan='$keperluan',divisi='$divisi',pemeriksa='$pemeriksa',tgl_kembali='$tgl_kembali',tgl_surat='$tgl_surat',jam_pakai='$jam_pakai',id_user='$id_user' WHERE id_surat='$id_surat'");
        ...
        $query = mysqli_query($config, "SELECT id_surat, nama, tujuan, keperluan, divisi, pemeriksa, tgl_kembali, tgl_surat, file, jam_pakai, id_user FROM transportasi WHERE id_surat='$id_surat'");
        list($id_surat, $nama, $tujuan, $keperluan, $divisi, $pemeriksa, $tgl_kembali, $tgl_surat, $file, $jam_pakai, $id_user) = mysqli_fetch_array($query);
        ...
        if($_SESSION['id_user'] != $id_user AND $_SESSION['id_user'] != 1){
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper teal darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons">edit</i> Edit Permintaan Transportasi</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <!-- Form START -->
                <form class="col s12" method="POST" action="?page=transportasi&act=edit" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Isi Jam Pakai">
                            <i class="material-icons prefix md-prefix">access_time</i>
                            <input id="jam_pakai" type="text" name="jam_pakai" class="validate" value="<?php echo $jam_pakai ;?>" required>
                        ...
                        <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Isi Tanggal kembali">
                            <i class="material-icons prefix md-prefix">date_range</i>
                            <input id="tgl_kembali" type="text" name="tgl_kembali" class="datepicker" value="<?php echo $tgl_kembali ;?>" required>
                            <label for="tgl_kembali">Tanggal Kembali</label>
                        </div>
                        <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Isi Keperluan">
                            <i class="material-icons prefix md-prefix">description</i>
                            <input id="keperluan" type="text" class="validate" name="keperluan" value="<?php echo $keperluan ;?>" required>
                        ...
                        <div class="input-field col s6">
                            <div class="file-field input-field tooltipped" data-position="top" data-tooltip="Jika tidak ada file/scan gambar transportasi, biarkan kosong">
                                ...
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" value="<?php echo $file ;?>" placeholder="Upload file/scan gambar transportasi">
                                        <?php
