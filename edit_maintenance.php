...

{
                                            ...
                                            if($file != ""){
                                                ...
                                                if(in_array($eks, $ekstensi) == true){
                                                    if($ukuran < 2300000){
                                                        ...
                                                        $query = mysqli_query($config, "SELECT file FROM maintenance WHERE id_surat='$id_surat'");
                                                        ...
                                                        if(!empty($file)){
                                                            ...
                                                            $query = mysqli_query($config, "UPDATE maintenance SET nama='$nama',keterangan='$keterangan',permintaan='$permintaan',divisi='$divisi',pemeriksa='$pemeriksa',tgl_surat='$tgl_surat',file='$nfile',id_user='$id_user' WHERE id_surat='$id_surat'");
                                                ...
                                                $query = mysqli_query($config, "UPDATE maintenance SET nama='$nama',keterangan='$keterangan',permintaan='$permintaan',divisi='$divisi',pemeriksa='$pemeriksa',tgl_surat='$tgl_surat',id_user='$id_user' WHERE id_surat='$id_surat'");
        ...
        $query = mysqli_query($config, "SELECT id_surat, nama, keterangan, permintaan, divisi, pemeriksa, tgl_surat, file, id_user FROM maintenance WHERE id_surat='$id_surat'");
        list($id_surat, $nama, $keterangan, $permintaan, $divisi, $pemeriksa, $tgl_surat, $file, $id_user) = mysqli_fetch_array($query);
        ...
        if($_SESSION['id_user'] != $id_user AND $_SESSION['id_user'] != 1){
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper teal darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons">edit</i> Edit Permintaan Layanan</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <!-- Form START -->
                <form class="col s12" method="POST" action="?page=maintenance&act=edit" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="permintaan" type="text" class="validate" name="permintaan" value="<?php echo $permintaan ;?>" required>
                        ...
                        <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Isi Keterangan Atau Barang">
                            <i class="material-icons prefix md-prefix active">note</i>
                        ...
                        <div class="input-field col s6">
                            <div class="file-field input-field tooltipped" data-position="top" data-tooltip="Jika tidak ada file/scan gambar surat, biarkan kosong">
                                ...
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" value="<?php echo $file ;?>" placeholder="Upload file/scan gambar permintaan layanan">
                                        <?php
